...
const rows: [string, string, string, boolean][] = [
  ...
  ["edit", "ai/pi/mcp.json", repo, true],
  ["write", "~/.config/mcp/mcp.json", repo, true],
  ["write", ".mcp.json", repo, true],
  ["bash", "echo {} > .pi/mcp.json", repo, true],
  ["read", ".mcp.json", repo, false],
  ["write", "docs/mcp.json", repo, false],
  ["write", "ai/pi/agents/scout.md", repo, true],
  ["edit", "~/.pi/agent/agents/planner.md", repo, true],
  ["bash", "echo x > ~/.agents/worker.md", repo, true],
  ["write", "~/.agents/mcp.json", repo, true],
  ["read", "ai/pi/agents/planner.md", repo, false],
