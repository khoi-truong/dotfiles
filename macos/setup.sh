...
# Set a blazingly fast keyboard repeat rate (lower values are faster values for KeyRepeat: 120, 90, 60, 30, 12, 6, 2)
defaults write NSGlobalDomain KeyRepeat -int 2

# Lower values are shorter values for InitialKeyRepeat (120, 94, 68, 35, 25, 15)
...
tell application "Terminal"
	...
	do shell script "open '$HOME/.dotfiles/settings/" & themeName & ".terminal'"
